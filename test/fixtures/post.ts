...
export const mockPost: Post = {
  ...
  body: [
    ...
    {
      quote:
        "The teams that win with agents are the ones that were already good at writing things down.",
    },
  ],
};
...
export const mockPosts: Post[] = [
  mockPost,
  {
    ...
    color: "indigo",
    summary:
      "A practical look at how I structure specs so an agent produces code you would actually merge.",
