...
export default function Tag({
  ...
  return (
    <span
      className={`${tagClasses[color] ?? tagClasses.indigo} border rounded-full text-2xs font-semibold tracking-[0.04em] px-2.5 py-[3px] font-sans inline-block whitespace-nowrap`}
    >
      {children}
    </span>
  );
